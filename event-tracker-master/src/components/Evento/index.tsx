...
import useExcluirEvento from '../../state/hooks/useEcluirEvento';
import style from './Evento.module.scss';
import EventoCheckbox from './EventoCheckbox';

const Evento: React.FC<{ evento: IEvento }> = ({ evento}) => {
  
  const apagarEvento = useExcluirEvento();
  ...
  return (<div className={estilos.join(' ')}>
    ...
    <i className="far fa-times-circle fa-2x" onClick={() => apagarEvento(evento)}></i>
  </div>)
}
