        ...
        return (
            <form className={style.novaTarefa} onSubmit={this.adicionarTarefa.bind(this)}>
                ...
                <div className={style.inputContainer}>
                    ...
                    <input type="time" step="1" name="tempo" id="tempo" min="00:00:00" 
                    value={this.state.tempo} onChange={evento => this.setState({...this.state, tempo: evento.target.value})} max="01:30:00" required />
                </div>
